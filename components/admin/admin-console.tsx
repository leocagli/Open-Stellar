...
import { Activity, AlertTriangle, Check, Code2, Copy, Cpu, ExternalLink, Fingerprint, History, KeyRound, Layers3, ListChecks, RadioTower, Rocket, Server, Shield, Terminal, Wallet } from "lucide-react"
import type { District, MoltbotAgent } from "@/lib/types"
import { PassportPanel } from "@/components/admin/passport-panel"

type AdminTab = "overview" | "queue" | "passport" | "private-deploy"
